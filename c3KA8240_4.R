...
PARAM <- list()
PARAM$experimento <- "c3KA8240_4"

PARAM$input$dataset <- "./datasets/competencia_03.csv"
...
PARAM$finalmodel$optim$num_iterations <- 2357
PARAM$finalmodel$optim$learning_rate <- 0.03851582
PARAM$finalmodel$optim$feature_fraction <- 0.98711914
PARAM$finalmodel$optim$min_data_in_leaf <- 22917
PARAM$finalmodel$optim$num_leaves <- 482
...
set.seed( 797897 )   #dejo fija esta semilla
cant_semillas  <- 80
